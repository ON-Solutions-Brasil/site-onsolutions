...
<section class="page-hero page-hero--about">
    <div class="container text-center">
        <span class="about-tag">Quem Somos</span>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="about-pillar-card">
                    ...
                    <p class="about-pillar-card__text">Transparência total, compromisso com resultados, inovação contínua, qualidade sem concessões e foco absoluto na experiência do cliente.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="about-why-card">
                    ...
                    <p class="about-why-card__text">Foco em conversão, eficiência e métricas que realmente importam pro seu negócio.</p>
                </div>
            </div>
        </div>
    </div>
