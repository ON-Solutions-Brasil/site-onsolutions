        ...
        <main class="settings-content">
            <div class="tab-content">
                ...
                <div class="tab-pane fade <?= ($tab ?? 'general') === 'general' ? 'show active' : '' ?>" id="tab-general">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            <div class="settings-card__header-icon bg-primary">
                                <i class="bi bi-gear"></i>
                            </div>
                            <div>
                                <h3 class="settings-card__title">Configurações Gerais</h3>
                                <p class="settings-card__desc">Informações principais do site e dados de contato</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>" enctype="multipart/form-data">
                                ...
                                <div class="settings-section">
                                    <h6 class="settings-section__title"><i class="bi bi-building"></i> Identidade</h6>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                ...
                                <div class="settings-section">
                                    <h6 class="settings-section__title"><i class="bi bi-image"></i> Imagens</h6>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                ...
                                <div class="settings-section">
                                    <h6 class="settings-section__title"><i class="bi bi-telephone"></i> Contato</h6>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                ...
                                <div class="settings-section">
                                    <h6 class="settings-section__title"><i class="bi bi-geo-alt"></i> Localização</h6>
                                    <div class="row g-3">
                                        <div class="col-12">
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'smtp' ? 'show active' : '' ?>" id="tab-smtp">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            <div class="settings-card__header-icon bg-info">
                                <i class="bi bi-envelope"></i>
                            </div>
                            <div>
                                <h3 class="settings-card__title">Configurações de Email (SMTP)</h3>
                                <p class="settings-card__desc">Configure o servidor de envio de emails</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
                                ...
                                <div class="settings-card__footer">
                                    <button type="submit" class="btn btn-primary settings-save-btn"><i class="bi bi-check-lg"></i> Salvar</button>
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'social' ? 'show active' : '' ?>" id="tab-social">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            <div class="settings-card__header-icon bg-warning">
                                <i class="bi bi-share"></i>
                            </div>
                            <div>
                                <h3 class="settings-card__title">Redes Sociais</h3>
                                <p class="settings-card__desc">Links dos perfis nas redes sociais</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'google' ? 'show active' : '' ?>" id="tab-google">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            <div class="settings-card__header-icon bg-success">
                                <i class="bi bi-graph-up"></i>
                            </div>
                            <div>
                                <h3 class="settings-card__title">Analytics & Tracking</h3>
                                <p class="settings-card__desc">Integrações com ferramentas de análise e rastreamento</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'ai' ? 'show active' : '' ?>" id="tab-ai">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            <div class="settings-card__header-icon bg-danger">
                                <i class="bi bi-robot"></i>
                            </div>
                            <div>
                                <h3 class="settings-card__title">APIs de Inteligência Artificial</h3>
                                <p class="settings-card__desc">Configure os provedores de IA e suas chaves de API</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'blog_ai' ? 'show active' : '' ?>" id="tab-blog-ai">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            <div class="settings-card__header-icon bg-secondary">
                                <i class="bi bi-journal-richtext"></i>
                            </div>
                            <div>
                                <h3 class="settings-card__title">Blog - Geração Automática por IA</h3>
                                <p class="settings-card__desc">Configure a geração automática de artigos com inteligência artificial</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'language' ? 'show active' : '' ?>" id="tab-language">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            ...
                            <div>
                                <h3 class="settings-card__title">Idiomas</h3>
                                <p class="settings-card__desc">Configure os idiomas disponíveis no sistema</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'chatbot' ? 'show active' : '' ?>" id="tab-chatbot">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            ...
                            <div>
                                <h3 class="settings-card__title">Chatbot do Site</h3>
                                <p class="settings-card__desc">Configure o assistente virtual integrado ao site</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
                ...
                <div class="tab-pane fade <?= ($tab ?? '') === 'whatsapp' ? 'show active' : '' ?>" id="tab-whatsapp">
                    <div class="settings-card">
                        <div class="settings-card__header">
                            ...
                            <div>
                                <h3 class="settings-card__title">WhatsApp</h3>
                                <p class="settings-card__desc">Configure o botão flutuante de WhatsApp no site</p>
                            </div>
                        </div>
                        <div class="settings-card__body">
                            <form method="POST" action="<?= url('admin/settings') ?>">
