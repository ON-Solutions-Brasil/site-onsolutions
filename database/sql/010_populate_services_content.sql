-- -----------------------------------------------------------
-- Populate services with rich content, features and technologies
-- -----------------------------------------------------------
...
<p>Dashboards interativos mostram a performance da equipe, taxa de conversão, ticket médio, tempo de ciclo de vendas e muito mais. Tome decisões baseadas em dados reais.</p>',
    `features` = ''["Gestão de contatos e empresas", "Pipeline de vendas visual (Kanban)", "Automação de e-mails e follow-ups", "Histórico completo de interações", "Agendamento de tarefas e lembretes", "Relatórios e dashboards em tempo real", "Integração com WhatsApp e e-mail", "Gestão de propostas e orçamentos", "Segmentação avançada de clientes", "Importação/exportação de dados", "API para integrações externas", "Permissões por usuário e equipe"]'',
    `technologies` = ''["PHP", "Laravel", "Vue.js", "MySQL", "Redis", "REST API", "WebSockets", "Bootstrap", "Chart.js"]'',
    `meta_description_pt` = 'CRM personalizado para gestão completa do relacionamento com clientes. Pipeline de vendas, automações, relatórios e integrações sob medida para seu negócio.'
WHERE `slug` = 'crm';
...
<p>Autenticação robusta, criptografia de dados, proteção contra ataques e backups automáticos. Seus dados e os dados dos seus clientes estão sempre protegidos.</p>',
    `features` = ''["Painéis administrativos completos", "Gestão de usuários e permissões", "APIs RESTful documentadas", "Integrações com sistemas externos", "Relatórios dinâmicos e exportação", "Notificações em tempo real", "Multi-idioma e multi-moeda", "Backup automático de dados", "Deploy contínuo (CI/CD)", "Documentação técnica completa", "Suporte e manutenção pós-entrega", "Escalabilidade horizontal"]'',
    `technologies` = ''["PHP", "Laravel", "Node.js", "Vue.js", "React", "MySQL", "PostgreSQL", "Redis", "Docker", "AWS", "REST API", "GraphQL"]'',
    `meta_description_pt` = 'Desenvolvimento de sistemas web completos e escaláveis. Plataformas corporativas, aplicações SaaS e soluções sob medida com tecnologia moderna.'
...
<p>Defina aprovações, notificações e ações automáticas para cada processo da sua empresa. O sistema segue as regras do seu negócio, não o contrário.</p>',
    `features` = ''["Módulo financeiro completo", "Gestão de estoque e inventário", "Controle de compras e fornecedores", "Gestão de vendas e pedidos", "Módulo de produção/manufatura", "Gestão de RH e folha", "Relatórios gerenciais avançados", "Workflows e aprovações", "Multi-empresa e filiais", "Notas fiscais e integração SEFAZ", "Dashboard executivo", "Controle de acessos granular"]'',
    `technologies` = ''["PHP", "Laravel", "Vue.js", "MySQL", "Redis", "REST API", "Docker", "ElasticSearch", "RabbitMQ"]'',
    `meta_description_pt` = 'ERP personalizado que integra todos os departamentos da sua empresa. Financeiro, estoque, vendas, produção e RH em uma única plataforma sob medida.'
...
<p>WhatsApp Business API, gateways de pagamento, marketplaces, ERPs, plataformas de e-mail marketing, redes sociais e muito mais.</p>',
    `features` = ''["APIs RESTful documentadas", "Integrações com WhatsApp Business", "Gateways de pagamento (Stripe, PagSeguro, Pix)", "Integração com marketplaces", "Webhooks e eventos em tempo real", "Sincronização de dados entre sistemas", "Filas de processamento assíncrono", "Logs e monitoramento de integrações", "Retry automático em caso de falha", "Documentação Swagger/OpenAPI", "Rate limiting e segurança", "Versionamento de APIs"]'',
    `technologies` = ''["REST API", "GraphQL", "Node.js", "PHP", "Python", "RabbitMQ", "Redis", "WebSockets", "OAuth 2.0", "Swagger", "Postman", "Docker"]'',
    `meta_description_pt` = 'Desenvolvimento de APIs e integrações entre sistemas. Conecte suas plataformas, automatize fluxos de dados e elimine processos manuais.'
...
<p>Geração automática de documentos, atualização de planilhas, sincronização de dados entre sistemas e alertas inteligentes.</p>',
    `features` = ''["Automação de e-mails e notificações", "Workflows visuais (drag and drop)", "Triggers baseados em eventos", "Automação de relatórios", "Integração com ferramentas existentes", "Agendamento de tarefas recorrentes", "Processamento em lote", "Alertas e notificações inteligentes", "Logs e auditoria de execuções", "Automação de social media", "Chatbots e respostas automáticas", "RPA (Automação Robótica de Processos)"]'',
    `technologies` = ''["Node.js", "Python", "n8n", "Redis", "RabbitMQ", "Cron Jobs", "Puppeteer", "Selenium", "REST API", "Webhooks"]'',
    `meta_description_pt` = 'Automação de processos empresariais. Elimine tarefas repetitivas, reduza erros e aumente a produtividade com automações inteligentes.'
...
<p>Defina indicadores-chave e receba alertas quando metas são atingidas ou quando algo precisa de atenção imediata.</p>',
    `features` = ''["Dashboards em tempo real", "KPIs e indicadores personalizados", "Gráficos interativos e drill-down", "Relatórios automatizados (PDF/Excel)", "Alertas e notificações de metas", "Integração com múltiplas fontes de dados", "Filtros dinâmicos e segmentação", "Compartilhamento e permissões", "Visualização mobile-friendly", "ETL e processamento de dados", "Previsões e tendências", "Exportação em múltiplos formatos"]'',
    `technologies` = ''["Chart.js", "D3.js", "Apache ECharts", "PHP", "Python", "MySQL", "PostgreSQL", "Redis", "ElasticSearch", "REST API"]'',
    `meta_description_pt` = 'Dashboards e Business Intelligence personalizados. Painéis interativos em tempo real para tomada de decisão baseada em dados.'
...
<p>Interfaces que seguem as guidelines de cada plataforma, com navegação intuitiva e design que encanta os usuários.</p>',
    `features` = ''["Apps para iOS e Android", "React Native (multiplataforma)", "Flutter para alta performance", "Push notifications", "Geolocalização e mapas", "Pagamentos in-app", "Câmera e mídia", "Armazenamento offline", "Autenticação biométrica", "Publicação nas lojas (App Store/Play Store)", "Analytics e métricas de uso", "Atualizações OTA (Over-the-Air)"]'',
    `technologies` = ''["React Native", "Flutter", "Swift", "Kotlin", "Firebase", "REST API", "GraphQL", "SQLite", "Redux", "TypeScript"]'',
    `meta_description_pt` = 'Desenvolvimento de aplicativos mobile para iOS e Android. Apps nativos e híbridos com React Native e Flutter.'
...
<p>Gestão completa de planos, cobranças recorrentes, trials, upgrades e downgrades integrada à plataforma.</p>',
    `features` = ''["Arquitetura multi-tenant", "Sistema de billing e assinaturas", "Onboarding automatizado", "Painel do cliente (self-service)", "API pública documentada", "Webhooks e integrações", "Gestão de planos e permissões", "Métricas SaaS (MRR, Churn, LTV)", "White-label customizável", "SSO e autenticação enterprise", "Escalabilidade horizontal", "Monitoramento e alertas"]'',
    `technologies` = ''["Laravel", "Vue.js", "React", "PostgreSQL", "Redis", "Stripe", "Docker", "Kubernetes", "AWS", "Terraform", "CI/CD"]'',
    `meta_description_pt` = 'Desenvolvimento de plataformas SaaS escaláveis e multi-tenant. Do MVP ao produto maduro com arquitetura preparada para crescer.'
WHERE `slug` = 'saas';
...
<p>Previsão de vendas, detecção de churn, scoring de leads e otimização de processos baseada em padrões históricos.</p>',
    `features` = ''["Chatbots com IA generativa", "Processamento de linguagem natural (NLP)", "Análise preditiva e forecasting", "Classificação e categorização automática", "Recomendações personalizadas", "Visão computacional", "Análise de sentimento", "Geração de conteúdo com IA", "OCR e extração de dados", "Integração com OpenAI/GPT", "Modelos customizados", "Treinamento com dados próprios"]'',
    `technologies` = ''["Python", "OpenAI API", "LangChain", "TensorFlow", "PyTorch", "scikit-learn", "FastAPI", "PostgreSQL", "Redis", "Docker", "Pinecone", "Hugging Face"]'',
    `meta_description_pt` = 'Soluções de Inteligência Artificial para empresas. Chatbots, análise preditiva, NLP e IA generativa aplicada ao seu negócio.'
...
<p>Criamos um plano prático e priorizado para modernizar sua operação, com marcos claros e ROI estimado para cada etapa.</p>',
    `features` = ''["Diagnóstico tecnológico completo", "Mapeamento de processos (AS-IS/TO-BE)", "Roadmap de transformação digital", "Arquitetura de soluções", "Seleção de tecnologias", "Due diligence técnica", "Code review e auditoria", "Otimização de performance", "Planejamento de escalabilidade", "Mentoria técnica para equipes", "Gestão de projetos (PMO)", "Análise de viabilidade técnica"]'',
    `technologies` = ''["UML", "BPMN", "Cloud Architecture", "Docker", "Kubernetes", "AWS", "Azure", "GCP", "Terraform", "CI/CD", "Agile/Scrum"]'',
    `meta_description_pt` = 'Consultoria tecnológica para transformação digital. Diagnóstico, roadmap, arquitetura de soluções e mentoria técnica.'
...
<p>Arquitetura preparada para crescimento: load balancing, auto-scaling, microserviços e filas de processamento assíncrono.</p>',
    `features` = ''["Auditoria de performance", "Otimização de queries SQL", "Implementação de cache (Redis/Memcached)", "CDN e otimização de assets", "Lazy loading e code splitting", "Compressão e minificação", "Load balancing", "Auto-scaling configurado", "Monitoramento de APM", "Core Web Vitals (Google)", "Stress testing e benchmarks", "Otimização de servidor"]'',
    `technologies` = ''["Redis", "Varnish", "Nginx", "CloudFlare", "New Relic", "Datadog", "Docker", "Kubernetes", "AWS", "Load Balancer", "ElasticSearch"]'',
    `meta_description_pt` = 'Otimização de performance e escalabilidade de sistemas web. Cache, CDN, otimização de banco e arquitetura para alto tráfego.'
